...
Sitemap: https://arc-development-next.vercel.app/sitemap_local.xml
Disallow:`;
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  ${Object.keys(pathsObj)
    ...
    ${
      path === "/index"
        ? `<loc>https://arc-development-next.vercel.app</loc>`
        : `<loc>https://arc-development-next.vercel.app${path}</loc>`
    }
    <lastmod>${
